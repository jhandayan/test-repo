    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                <li class="active">{{ $user->full_name }} Logs</li>
            </ul>
        </div>
    </div>
    <div class="row">
            ...
            <div class="panel panel-default bootstrap-admin-no-table-panel">
                <div class="panel panel-default bootstrap-admin-no-table-panel">
                    <div class="panel-heading">
                        <div class="text-muted bootstrap-admin-box-title">{{ $user->full_name }} Logs List</div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table width="100%" class="table table-striped table-hover">
                                    ...
                                    <tr>
                                        <th width="15%"></th>
                                        <th width="55%"><a href="{{ route('user_logs').'?page='.$page_number.'&search='.$search.'&order_by=last_name&sort='.$sort }}">Log Description</a></th>
